resource "aws_instance" "web1" {
  ...
  vpc_security_group_ids = ["sg-03fb74a83e964e06f"]
   ...
   user_data = <<-EOF
      ...
      cd /home/ec2-user/Terra-Ansi-jFrog && wget -O Java-Ansible.war https://annappa.jfrog.io/artifactory/annappa_new/MyMavanWebapp/Java-Ansible/0.0.1-SNAPSHOT/Java-Ansible-0.0.1-SNAPSHOT.war
